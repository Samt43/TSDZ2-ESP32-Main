...
#define CT_TX_PIN           GPIO_NUM_13  // Controller TX and RX2 for ESP32
#define CT_RX_PIN           GPIO_NUM_15  // Controller RX and TX2 for ESP32
#define LCD_TX_PIN          GPIO_NUM_25  // LCD TX and RX1 for ESP32
#define LCD_RX_PIN          GPIO_NUM_26  // LCD RX and TX1 for ESP32
